...
// Maps the errcodes raised by the checkout_close / inventory_adjust RPCs.
// Their messages are already safe, user-facing text (no SQL/stack/secrets),
// set deliberately in the migration, so they are passed through as-is.
