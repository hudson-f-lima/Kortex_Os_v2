...
| Onda 3 — Compensation | [017](017-organizations-settings-feature-flag.md) · [018](018-staff-levels-professional-assignment.md) · [019](019-staff-level-service-overrides-pricing-resolution.md) · [020](020-package-sale-commission-records.md) | Blueprint aprovado (DEC-46); fatias 017-020 implementadas e verificadas localmente via `$tdd` (647/647 pgTAP); ainda não promovidas | [Blueprint](../docs/waves/onda-3-compensation/KORTEXOS_5_1_2_BLUEPRINT_ONDA_3.md); ADR 0020 (`Accepted`); migrations `20260728000000`–`20260728030000` |
