...
| Onda 3 — Compensation | [017](017-organizations-settings-feature-flag.md) · [018](018-staff-levels-professional-assignment.md) · [019](019-staff-level-service-overrides-pricing-resolution.md) · [020](020-package-sale-commission-records.md) | Blueprint aprovado (DEC-46); fatia 017 implementada e verificada localmente via `$tdd` (579/579 pgTAP); 018-020 ainda não implementadas | [Blueprint](../docs/waves/onda-3-compensation/KORTEXOS_5_1_2_BLUEPRINT_ONDA_3.md); ADR 0020 (`Accepted`); migration `20260728000000_onda3_organizations_settings_feature_flag.sql` |
