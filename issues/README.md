...
| Onda 3 — Compensation | [017](017-organizations-settings-feature-flag.md) · [018](018-staff-levels-professional-assignment.md) · [019](019-staff-level-service-overrides-pricing-resolution.md) · [020](020-package-sale-commission-records.md) · 021 · 022 | Blueprint aprovado (DEC-46); fatias 017-020 implementadas via `$tdd` (647/647 pgTAP) e mescladas em `staging`, regularizado por DEC-47; auditoria pós-merge achou vínculo pacote↔pedido inexistente e `commission_sale_records` sem proteção de mutação — correção autorizada por DEC-48, fatias 021-022 em andamento; `NO-GO` para `main`/produção | [Blueprint](../docs/waves/onda-3-compensation/KORTEXOS_5_1_2_BLUEPRINT_ONDA_3.md); ADR 0020 (`Accepted`, emendada por DEC-48); migrations `20260728000000`–`20260728030000` |
