...
- **Ambiente de homologação inexistente** (Gap #4 do MVP) se torna mais grave, não menos, à medida que o produto final adiciona ledger/pagamento real — hoje qualquer regressão financeira vai direto para produção sem QA intermediário.
