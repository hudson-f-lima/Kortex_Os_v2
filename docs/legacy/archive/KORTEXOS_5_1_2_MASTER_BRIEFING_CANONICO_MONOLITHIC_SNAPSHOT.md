...
| 7 | Blueprint Unificado 5.1.2 | Incorporar Opportunity Engine, Contact Orchestrator, Automation Control Plane e API Booking | DESBLOQUEADO por DEC-24, sem ressalva pendente — cobertura de D02 fechada por DEC-25; pontos cegos de profundidade resolvidos por DEC-26; hierarquia Empresa→Unidade modelada e finalizada por DEC-27/DEC-28. **Onda 0 (`units`): Blueprint CONCLUÍDO e APROVADO (DEC-31)** — ver `KORTEXOS_5_1_2_BLUEPRINT_ONDA_0_DRAFT.md`. **Onda 1 (Payment Core): Blueprint CONCLUÍDO e APROVADO (DEC-34)** — ver `KORTEXOS_5_1_2_BLUEPRINT_ONDA_1_DRAFT.md` e ADR 0017. Ondas 2–6 aguardam início |
| 8 | SQL Master | Materializar em banco | **Onda 0: CORRIGIDA E VALIDADA localmente em 2026-07-24** — schema/backfill originais mais migration forward-only de segurança, 109 testes pgTAP específicos, suíte pgTAP integral 346/346, backend 255/255 e frontend 106/106; ver `KORTEXOS_5_1_2_ONDA_0_IMPLEMENTATION.md` e `KORTEXOS_5_1_2_ONDA_0_IMPLEMENTATION_REDTEAM.md`. Promoção remota pendente; produção fora do escopo. **Onda 1: BLOQUEADO até autorização própria da Etapa 8** (Blueprint aprovado não autoriza SQL — DEC-34 explicitamente não inclui essa autorização). Ondas 2–6: BLOQUEADO (Blueprint pendente) |
