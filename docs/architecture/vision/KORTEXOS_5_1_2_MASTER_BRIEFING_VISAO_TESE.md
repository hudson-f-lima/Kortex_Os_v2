...
| 7 | Blueprint Unificado 5.1.2 | Incorporar Opportunity Engine, Contact Orchestrator, Automation Control Plane e API Booking | **Onda 0:** Blueprint aprovado (DEC-31) e implementado. **Onda 1:** Blueprint aprovado (DEC-34), refinado pela correção forward-only de DEC-38. **Onda 2:** Blueprint aprovado (DEC-41), fatiado em issues 012–016 e implementado localmente sob DEC-42. **Onda 3:** Blueprint aprovado (DEC-46), emendado por DEC-48, fatiado em issues 017–022. Ondas 4–6 aguardam início. |
| 8 | SQL Master | Materializar em banco | **Onda 0:** validada e em `staging`. **Onda 1:** Etapa 8 corretiva autorizada por DEC-38; promoção para produção permanece `NO-GO`. **Onda 2:** migrations e testes locais validados sob DEC-42, mas sem promoção para `staging`/`main`. **Onda 3:** Etapa 8 regularizada por DEC-47/DEC-48; fatias 017–022 implementadas, verificadas e mescladas em `staging` (PR #24, PR #25); promoção para `main`/produção permanece `NO-GO` até os gates de ambiente/entrega/homologação. Ondas 4–6 seguem bloqueadas até Blueprint e autorização próprios. |
