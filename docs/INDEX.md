...
| Onda 6 — Checkout final: reabertura de comanda | **REAL local — fatias 055–060 fechadas (DEC-66)**: schema de versão/reabertura, RLS/grants, fatos financeiros imutáveis, journal privado, `checkout_close` dark-launched e Commands de solicitação/aprovação/reabertura/descarte/refinalização/refund. A abertura reverte o v1 por snapshot/journal; o descarte o restaura sem movimentar caixa; a 059 grava v2 e só o delta de caixa; a 060 mantém refund legado e reverte o ledger de pedido versionado mesmo se a flag estiver desligada. Pedido legado, lock terminal e intent capturado são bloqueados. Evidência: reset limpo, 1.048/1.048 pgTAP antes e depois de 328/328 backend, 117/117 PWA e lint sem erros. A fatia 061 segue aprovada para execução via TDD. | Não autoriza ativação, `staging`, `main` ou produção | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62; fatias 055–060 implementadas e validadas localmente por Red Team (`GO`), com 061 aprovada sob DEC-66; sem ativação ou promoção.
