...
| Onda 6 — Checkout final: reabertura de comanda | **REAL local — fatias 055–059 fechadas (DEC-66)**: schema de versão/reabertura, RLS/grants, fatos financeiros imutáveis, journal privado, `checkout_close` dark-launched e Commands de solicitação/aprovação/reabertura/descarte/refinalização. A abertura reverte o v1 por snapshot/journal; o descarte o restaura sem movimentar caixa; a 059 grava v2 e só o delta de caixa, com refund proporcional determinístico. Pedido legado, lock terminal e intent capturado são bloqueados. Evidência: reset limpo, 1.036/1.036 pgTAP antes e depois de 327/327 backend, 117/117 PWA e lint sem erros. Fatias 060–061 seguem aprovadas para execução sequencial via TDD. | Não autoriza ativação, `staging`, `main` ou produção | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62; fatias 055–059 implementadas e validadas localmente por Red Team (`GO`), com 060–061 aprovadas sob DEC-66; sem ativação ou promoção.
