...
| Onda 6 — Checkout final: reabertura de comanda | **REAL local — fatias 055–061 fechadas (DEC-66)**: schema de versão/reabertura, RLS/grants, fatos financeiros imutáveis, journal privado, `checkout_close` dark-launched e Commands de solicitação/aprovação/reabertura/descarte/refinalização/refund. A 061 corrigiu o gap real de serialização: o produtor de financial lock e a comissão de venda agora travam a mesma linha de pedido e rejeitam estado/revisão obsoletos. Evidência: reset limpo, 1.060/1.060 pgTAP antes e depois de 328/328 backend, 117/117 PWA e lint sem erros. | Não autoriza ativação, `staging`, `main` ou produção; DEC pós-Red-Team e gates de ambiente permanecem obrigatórios | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62; fatias 055–061 implementadas e validadas localmente por Red Team (`GO LOCAL`) sob DEC-66; sem ativação ou promoção.
