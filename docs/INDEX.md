...
| Onda 6 — Checkout final: reabertura de comanda | **BLUEPRINT APROVADO (DEC-62)** — quatro rodadas de Red Team fecharam vínculo ledger↔pedido, trava de depósito, concorrência, rollback da flag e grants das primitives. Fatiamento produzido em [issues 055-061](../issues/README.md), tradução direta do §6 do Blueprint, **aguardando validação do Platform Owner** | Etapa 8 bloqueada até aprovação do fatiamento e autorização própria — nenhuma das duas concedida ainda | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62 após Red Team de desenho `GO`; fatiamento (issues 055-061) produzido e proposto, aguardando validação do Platform Owner; Etapa 8 depende dessa validação e de autorização própria — nenhuma concedida ainda.
