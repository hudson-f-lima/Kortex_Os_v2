...
| Onda 6 — Checkout final: reabertura de comanda | **REAL local — fatias 055–057 fechadas (DEC-66)**: schema de versão/reabertura, RLS/grants, fatos financeiros imutáveis, primitive privada de ledger/journal e `checkout_close` dark-launched. Ausência/`false` na flag preserva o checkout legado; boolean JSON `true` cria journal balanceado, snapshot v1 e closure link atomicamente. Evidência: 990/990 pgTAP, 325/325 backend, 116/116 PWA e lint sem erros. Fatias 058–061 continuam aprovadas para execução sequencial via TDD. | Não autoriza ativação, `staging`, `main` ou produção | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62; fatias 055–057 implementadas e validadas localmente por Red Team (`GO`), com 058–061 aprovadas sob DEC-66; sem ativação ou promoção.
