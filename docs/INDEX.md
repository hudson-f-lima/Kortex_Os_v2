...
- [KORTEXOS_5_1_2_BLUEPRINT_ONDA_2_DRAFT.md](KORTEXOS_5_1_2_BLUEPRINT_ONDA_2_DRAFT.md) — **Rascunho, `$kortex-qa-redteam` de desenho GO (2ª rodada), AGUARDANDO APROVAÇÃO DO PLATFORM OWNER — nenhum DEC registrado ainda.** Desenho da Onda 2 (KortexFlow Ledger + Wallet & Current Accounts, D15/D16): fundação só, sem produtor real (`checkout_close` intocado nesta Onda). Etapa 8 (SQL) segue bloqueada até aprovação explícita.
