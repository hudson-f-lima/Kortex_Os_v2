...
| Onda 6 — Checkout final: reabertura de comanda | **ETAPA 8 LOCAL AUTORIZADA (DEC-66)** — Blueprint aprovado (DEC-62), fatiamento [055–061](../issues/README.md) validado e pronto para execução sequencial via TDD; nenhuma fatia implementada ainda. | Não autoriza ativação, `staging`, `main` ou produção | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62 após Red Team de desenho `GO`; fatiamento 055–061 validado e Etapa 8 local autorizada por DEC-66, sem ativação ou promoção.
