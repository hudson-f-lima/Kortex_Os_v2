...
| Onda 6 — Checkout final: reabertura de comanda | **REAL local — fatia 055 fechada (DEC-66)**: schema de versão/reabertura, RLS/grants e fatos financeiros imutáveis; Red Team de implementação local `GO` (938/938 pgTAP, 325/325 backend, PWA 116/116, lint sem erros). Fatias 056–061 continuam aprovadas para execução sequencial via TDD. | Não autoriza ativação, `staging`, `main` ou produção | [Onda 6](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) |
...
- [Onda 6 — Checkout final: reabertura de comanda](waves/onda-6-checkout-reopen/BLUEPRINT_ONDA_6.md) — Blueprint aprovado por DEC-62; fatia 055 implementada e validada localmente por Red Team (`GO`), com 056–061 aprovadas sob DEC-66; sem ativação ou promoção.
